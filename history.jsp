...
<body>
 ...
 <%
   ...
   String user = (String)session.getAttribute("userId");
    ...
    PreparedStatement pst = conn.prepareStatement("select track from history where user = '"+user+"' order by ts desc");
  ...
  %>
    <tr>
    <td align="center">User <%=user%> listened to <%=rs.getString(1)%></td>
    </tr>
<%
    }
conn.close();
