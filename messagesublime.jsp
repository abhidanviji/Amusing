...
<body>
	...
	<%
		...
		ResultSet rset = stmt.executeQuery("select userid from amlogin where userid != '"+(String)session.getAttribute("userId")+"';");
    ...
    <li><a><input id="search-bar" name="search" type="text"
						placeholder="Search to find tracks">
      <input id="search-button" name="search_submit" type="submit"
						value="Search"></a></li>
      </form>
    <div class="clear"></div>
  </ul>
    ...
    <form class="form" id="form1" action="sendtext.jsp">
      ...
      <p class="from">
        <input name="from" type="text"
				...
				<p class="to">
				<select name="to" class="validate[required,custom[onlyLetter],length[0,100]] feedback-input"
